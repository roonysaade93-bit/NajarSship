...
import { FaExclamationTriangle, FaClock, FaShieldAlt } from 'react-icons/fa'; // וודא שיש לך react-icons

const LandingRescue = () => {
  // הודעת וואטסאפ מותאמת ל"חילוץ"
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-slate-900 text-white font-sans relative overflow-hidden">
      {/* רקע דרמטי - אפשר להחליף בתמונה אמיתית של נמל */}
      <div className="absolute inset-0 bg-[url('/path-to-busy-port.jpg')] bg-cover bg-center opacity-20"></div>
      
      {/* Overlay אדמדם עדין ליצירת לחץ */}
